# Chiabee wallet quick guide
Hello everyone, we are the chiabee team from China.

We are currently working on an offline wallet for Chia. The biggest feature of this wallet is that multiple accounts can be managed with the same set of mnemonic phrases and can be used offline.

Because all our energy is currently devoted to development, this document is temporarily translated by google. Feedback is welcome, thank you!
